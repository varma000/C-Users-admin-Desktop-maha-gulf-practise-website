        ...
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="text-center mb-16 mt-28">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-12 text-pretty">
              MAHA Gulf is officially approved to deliver the IOSH Managing
              Safely E-Learning program. This globally recognized course helps
              managers and supervisors gain essential knowledge in health and
              safety management with flexible online learning.
            </p>
          </div>
        </div>
      </section>
